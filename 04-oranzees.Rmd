...
We can use the same codes of Whiten et al., 1999, to see how many behaviours are codes as 'customary', 'habitual', 'present', or 'absent'. We use for now custom boundaries (see the code below), as there is not a precise quantitative definition in Whiten et al. Of course, these can be changed for the final analysis (see [06-oranzees.html](06-oranzees.html), where other boundaries of these codes - possbily closer to the original analysis - are discussed and tested). We also distinguish the results for social and food-related behaviours: 
