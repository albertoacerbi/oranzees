...
write(t(food_test1), file = "output/food_test.csv", ncolumns = 22)
write(test_world$p_g[17:38], file = "output/food_test_p_g.csv", ncolumns = 1)
write(test_world$p_e[17:38], file = "output/food_test_p_e.csv", ncolumns = 1)
```
