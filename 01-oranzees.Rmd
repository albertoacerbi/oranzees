...
data_to_plot <- tibble(x = oranzees_world[oranzees_world$population == "Uossob", ]$p_g, y = oranzees_world[oranzees_world$population == "Iat Forest", ]$p_g)
p1 <- p +
  geom_point(data = data_to_plot) +
  labs(x = "Uossob", y = "Iat Forest")

data_to_plot <- tibble(x = oranzees_world[oranzees_world$population == "Uossob", ]$p_g, y = oranzees_world[oranzees_world$population == "Elabik", ]$p_g)
p2 <- p +
  geom_point(data = data_to_plot) +
...
```{r warning=FALSE}
data_to_plot <- tibble(x = oranzees_world[oranzees_world$population == "Uossob", ]$p_e, y = oranzees_world[oranzees_world$population == "Iat Forest", ]$p_e)
p1 <- p +
  geom_point(data = data_to_plot) +
  labs(x = "Uossob", y = "Iat Forest")

data_to_plot <- tibble(x = oranzees_world[oranzees_world$population == "Uossob", ]$p_e, y = oranzees_world[oranzees_world$population == "Elabik", ]$p_e)
p2 <- p +
  geom_point(data = data_to_plot) +
  labs(x = "Uossob", y = "Elabik")
