...
par(pty = "s")
plot(oranzees_environment[oranzees_environment$population == 1, ]$p_g, oranzees_environment[oranzees_environment$population == 2, ]$p_g, pch = 19, 
...
And the same for the ecological availabilities:

```{r}

par(pty = "s")
plot(oranzees_environment[oranzees_environment$population == 1, ]$p_e, oranzees_environment[oranzees_environment$population == 2, ]$p_e, pch = 19, 
      xlab = "Population 1", ylab = "Population check", xlim = c(0, 1), ylim = c(0, 1))
